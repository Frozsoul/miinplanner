  ...
  return (
    <Link href="/dashboard" className={cn("flex items-center", className)}>
      ...
      >
        <style>{`
          .st0{fill:none;}
          .st1{fill:var(--sidebar-background);}
          .st2{fill:var(--sidebar-primary);}
          .st3{fill:var(--sidebar-foreground);}
        `}</style>
        <g>
        ...
        <text transform="matrix(2.3291 0 0 1 41.3633 177.0051)" className="st3">MIIN</text>
        <text transform="matrix(2.3291 0 0 1 1063.3652 176.6809)" className="st3">DIGITAL</text>
      </svg>
    </Link>
  );
}
